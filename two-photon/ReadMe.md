...
- The data is made publically available by Allen Institue of Brain Science and can be found at [here](http://observatory.brain-map.org/visualcoding).
...
- Four different types of classifiers have been implemented
